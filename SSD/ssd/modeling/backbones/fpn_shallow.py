...
class FPN(torch.nn.Module):
    def __init__(self, output_channels: List[int],
        ...
        if self.flag == "fpn":
            chan = 64
        elif self.flag == "fpnDeep" or self.flag == "BiFPN" or self.flag == "AdamFPN" or self.flag == "BiFPN6":
            chan = 256
                            
        ## Add feature extractors
        ###############################################################################################################
        if self.flag == "fpn" or self.flag == "fpnDeep" or self.flag == "BiFPN":
        ...
        if self.flag == "AdamFPN" or self.flag == "BiFPN6":
            self.feature_extractorP2 = torch.nn.Sequential(                                     # 32x256
                self.oldModel.conv1,
                self.oldModel.bn1,
                self.oldModel.relu,
        ...
        #BiFPN
        if self.flag == "BiFPN" or self.flag == "BiFPN6":
